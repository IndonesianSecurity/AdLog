...
_/  _/   _/_/_/    _/_/_/_/  _/_/      _/_/_/      
                                          _/       
                                     _/_/_/ 
Dev with Heart @IndonesianSecurity"""

print BANNER

print """\n  I am not responsible for your shit and if you get some error while
 running AdLog, there are good chances that target isn't responding.\n"""
print "\033[1;31m--------------------------------------------------------------------------\033[1;m\n"
try:
	target = target.replace('https://', '') #Removes https://
except:
	print '\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python adlog -h for help'
	quit()
